          ...
          return state.status == LocationStatus.loading
              ...
              : FlutterMap(
                  ...
                  options: MapOptions(
                    ...
                    maxZoom: 18,
                    center: LatLng(state.currentLocation?.latitude ?? 11.542441,
                        state.currentLocation?.longitude ?? 107.811172),
                    zoom: state.zoom,
               ...
               */
                    ...
                    AnimatedLocationMarkerLayer(
                      ...
                      position: LocationMarkerPosition(
                        latitude: state.currentLocation?.latitude ?? 11.542441,
                        longitude:
                            state.currentLocation?.longitude ?? 107.811172,
                        accuracy: 0.2,
                      ),
                    ...
                    MarkerLayer(rotate: true, markers: [
                      Marker(
                          ...
                          height: 45,
                          point: LatLng(
                              state.currentLocation?.latitude ?? 11.542441,
                              state.currentLocation?.longitude ?? 107.811172),
